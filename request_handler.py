...
def get_book(book_id: str):
    ...
    book_data["details"] = "http://localhost:8001/book/details/" + book_id
    return book_data
...
def add_book_review(book_review: BookReviewModel):
    ...
    response_content = {
        ...
        "status": "http://localhost:8001/book/review/" + str(review_temporary_id) + "/status"
    }
...
def get_book_review_status(review_id: str):
    ...
    return {
        "review_id": review_id,
        "status": "http://localhost:8001/book/review/" + review_id
    }
